      ...
      if (search === "" || matchSearch) {
        ...
        div.addEventListener("click", () => {
          ...
          if (item.type === "point" && typeof item.x === "number" && typeof item.y === "number") {
            ...
            const scrollX = (x - map.clientWidth / 2);
            const scrollY = (y - map.clientHeight / 2);
            originX = -scrollX / targetScale;
            originY = -scrollY / targetScale;
            scale = targetScale;
            ...
            const scrollX = (centerX - map.clientWidth / 2);
            const scrollY = (centerY - map.clientHeight / 2);
            originX = -scrollX / targetScale;
            originY = -scrollY / targetScale;
            scale = targetScale;
            map.style.transform = `scale(${scale}) translate(${originX}px, ${originY}px)`;
